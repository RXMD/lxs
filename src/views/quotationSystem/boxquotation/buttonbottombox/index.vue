<template>
  <div v-loading="loading" class="YZ-common-layout-form mini-form">
      ...
      <div class="product-form-box">
        ...
        <div class="product-info-form h-100 form-right-box">
          <div class="grid-content1 bg-purple-dark">
            <el-row>
              <el-col :span="4">
                <div class="grid-content bg-purple-dark fz-12 grid-label" style="flex-wrap: wrap">
                  盒型选择
                  <br>
                  <el-select v-model="form.sBoxType" size="mini" class="boxSelect" placeholder="请选择" @change="changeBoxTypePID">
                    <el-option v-for="item in boxTypeOptions" :key="item.F_TypeName" :label="item.F_TypeName" :value="item.F_TypeName" />
                  </el-select>
                </div>
              </el-col>
              <el-col :span="20">
                <div class="grid-content bg-purple-dark fz-12 text-left">
                  <el-radio-group v-model="form.sBoxName" class="type-radios" size="mini" @change="changeBoxType">
                    <el-radio v-for="item in boxTypeList" :key="item.F_TypeName" :label="item.F_TypeName" border>{{ item.F_TypeName }}</el-radio>
                  </el-radio-group>
                </div>
              </el-col>
            </el-row>
            ...
            <el-row>
              ...
              <el-col :span="20" style="display:flex;align-items:center;" class="grid-content bg-purple-dark fz-12">
                <div>
                  <el-input v-model="form.dQty" size="mini" />
                </div>
                <div v-if="filterSticky.includes(form.sBoxName)">
                  <el-checkbox v-model="form.bUnifySticky" size="mini" class="ml-5">统一粘口位</el-checkbox>
                </div>
              </el-col>
            </el-row>
            <el-row>
              ...
              <el-col :span="20">
                <div class="grid-content">
                  <div class="row-box">
                    <el-row>
                      ...
                      <el-col :span="12">
                        <el-checkbox
                          ...
                          size="mini"
                          @change="v => changeAfterProcess(v, 'Ele_ColorBoxSetting_AfterProcess_Surface', 'surfaceDataSourceList')"
                        >
                          正面表面处理
                        </el-checkbox>
                    ...
                    <el-row class="mt-5">
                      <el-col :span="12" class="flex-row fz-12">
                    ...
                    <el-row class="mt-5">
                      ...
                      <el-col :span="12">
                        <el-checkbox
                          ...
                          size="mini"
                          @change="v => changeAfterProcess(v, 'Ele_ColorBoxSetting_AfterProcess_HandRope', 'handRopeDataSourceList')"
                        >
                          手提绳
                        </el-checkbox>
                    ...
                    <el-row class="mt-5">
                      <el-col :span="12">
                        <el-checkbox
                          ...
                          size="mini"
                          @change="v => changeAfterProcess(v, 'Ele_ColorBoxSetting_AfterProcess_CuttingTemplate', 'cuttingTemplateDataSourceList')"
                        >
                          模切
                        </el-checkbox>
                    ...
                    <el-row class="mt-5">
                      <el-col :span="12">
                        <el-checkbox
                          ...
                          size="mini"
                          @change="v => changeAfterProcess(v, 'Ele_ColorBoxSetting_AfterProcess_Package', 'packageDataSourceList')"
                        >
                          包装
                        </el-checkbox>
                    ...
                    <el-row class="mt-5">
                      <el-col :span="24" class="d-flex ai-c">
                    ...
                    <el-row class="mt-5">
                      <el-col :span="24" class="d-flex ai-c">
                        <el-checkbox
                          ...
                          size="mini"
                          @change="v => changeAfterProcess(v, 'Ele_ColorBoxSetting_AfterProcess_LocalEmbossing', 'localEmbossingDataSourceList')"
                        >
                          局部压纹
                        </el-checkbox>
                    ...
                    <el-row class="mt-5">
                      <el-col :span="24" class="d-flex ai-c">
                        <el-checkbox
                          ...
                          size="mini"
                          @change="v => changeAfterProcess(v, 'Ele_ColorBoxSetting_AfterProcess_FullEmbossing', 'fullEmbossingDataSourceList')"
                        >
                          满版压纹
                        </el-checkbox>
                    ...
                    <el-row class="mt-5">
                      <el-col :span="24" class="d-flex ai-c fz-12">
                        <el-checkbox
                    ...
                    <el-row class="mt-5">
                      <el-col :span="24" class="d-flex ai-c fz-12">
                        <el-checkbox
                          ...
                          size="mini"
                          @change="v => changeAfterProcess(v, 'Ele_ColorBoxSetting_AfterProcess_HotGold', 'hotGoldDataSourceList')"
                        >
                          烫金
                        </el-checkbox>
                      ...
                      <el-col :span="24" class="d-flex ai-c">
                        <div class="flex-row fz-12">
                          <el-checkbox
                            ...
                            size="mini"
                            @change="v => changeAfterProcess(v, 'Ele_ColorBoxSetting_AfterProcess_LocalUV', 'localUVDataSourceList')"
                          >
                            局部UV
                          </el-checkbox>
                              ...
                              <el-table-column width="300" label="设置（说明：要设置多其他后工请单击右边按钮）">
                                <template slot-scope="scope">
                                  <el-select v-model="scope.row.sName" size="mini" @change="value => changeAfterProcessName(value, scope.row)">
                                    <el-option
                                      v-for="(item, idx) in optionConfig.otherAfterDataSourceList"
                                      :key="idx"
                                      :label="item.sName"
                                      :value="item.sName"
                                    />
                              ...
                              <el-table-column width="80" align="center" label="操作">
                                <template slot-scope="scope">
                                  ...
                                  <el-button
                                    ...
                                    circle
                                    class="v-mini-btn"
                                    @click.stop="removeOtherPostRow(scope.$index)"
                                  />
                                </template>
                              </el-table-column>
                            </el-table>
            ...
            <el-row class="footer">
              <el-col :span="7" class="opacity-box">
                <el-popover
                  v-model="isShow"
                  popper-class="formNumber"
                  placement="top"
                  width="123"
                  trigger="click"
                >
                  <ul>
                    <li v-for="(item, index) in Object.keys(formNumber)" :key="item">
                      <el-input v-model="formNumber[item]" oninput="value=value.replace(/[^\d]/g,'')" />
                      <i v-show="index != 0" class="el-icon-close" @click="formNumber[item] = 0" />
                    </li>
                  </ul>
                  <div slot="reference" class="text">多数量 <i v-if="!isShow" class="el-icon-arrow-down" /> <i v-else class="el-icon-arrow-up" /></div>
                </el-popover>
              </el-col>
              <el-col :span="17">
    ...
    <el-dialog v-DialogDrag width="70%" title="报价成本明细" :visible.sync="quotationPriceDetailsVisible" append-to-body :close-on-click-modal="false" @close="quotationPriceDetailsVisible = false">
      <div id="quoteDetailDiv1" ref="quotationPriceDetails">
        <div id="erpIframe" />
...
import { deepClone, sortOrder, guid, getQueryObject } from '@/utils/tool'
...
export default {
  ...
  data() {
    return {
      ...
      bigimgList: imgsData['扣底盒'], // 初始化为扣底盒
      bigimg: imgsData['扣底盒'][0].imgsrc, // 初始化为扣底盒
      index: 0,
      loading: false,
      form: {
        sBoxType: '扣底盒',
      ...
      filterSticky: ['同边插双插盒', '同边双插盒带保险扣', '同边双插盒带挂钩保险扣', '带挂钩双插盒', '双插盒侧粘口']// 展示统一粘口位的类型
    }
  },
  computed: {
    // 展开尺寸
  ...
  methods: {
    // 打印
    print() {
      const printContent = this.$refs.quotationPriceDetails
      // 获取dom 宽度 高度
    ...
    initData() {
      ...
      // //获取模切
      // const GetBoxTypeQuotationBuckleBottomBoxAfterProcessDataSource = Api.GetBoxTypeQuotationBuckleBottomBoxAfterProcessDataSource('Ele_ColorBoxSetting_AfterProcess_PasteBoxUniformPrice,Ele_ColorBoxSetting_AfterProcess_CuttingTemplate,Ele_ColorBoxSetting_AfterProcess_Package,Ele_ColorBoxSetting_AfterProcess_Surface');
      // Promise.all([GetBoxTypeQuotationBuckleBottomBoxDataSource, GetBoxTypeQuotationBuckleBottomBoxListData, GetBoxTypeQuotationBuckleBottomBoxAfterProcessDataSource]).then(res => {
      ...
      //         }
      //         this.$nextTick(() => {
      //             this.changeMaterialType(this.form.sFacePaperMaterialType)
      //         })
      //     } else {
      //         this.form = {
    ...
    getBoxType() {
      this.boxTypeList = this.boxTypeOptions.find(item => {
        return item.F_TypeName == this.form.sBoxType
      }).children
      this.$set(this.form, 'sBoxName', this.boxTypeList[0].F_TypeName)
      this.initData()
    },
    // 自动报价
    automaticQuotationSubmit() {
      ...
      if (!this.formNumber.num1) {
        this.noticfy('请输入订单数量！')
        return false
      }
      for (const key in this.formNumber) {
        if (typeof this.formNumber[key] === 'string' && this.formNumber[key].trim() === '') {
          this.noticfy(`请输入数量${key.charAt(3)}！`)
          return false
        }
      }
      this.loading = true
