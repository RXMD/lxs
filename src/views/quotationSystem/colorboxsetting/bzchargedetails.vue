<template>
  <transition name="el-zoom-in-center">
    <el-tabs type="border-card" class="w-100 h-100">
      <el-tab-pane label="后工包装参数设置" class="w-100 h-100">
        <div ref="view" class="YZ-preview-main">
          <div class="w-100 pd-0">
            ...
            >
              ...
              <el-table-column align="center" label="单个包装重量/数量">
                <template slot-scope="scope">
              ...
              <el-table-column align="center" label="操作" width="80" fixed="right">
                <template slot-scope="scope">
                  ...
                  <el-button size="mini" type="text" class="YZ-table-delBtn" @click="remove(scope.row, scope.$index, 'Ele_ColorBoxSetting_AfterProcess_Package')">
                    删除
                  </el-button>
                </template>
              </el-table-column>
...
export default {
  ...
  methods: {
    ...
    sumbit() {
      ...
      Api.SaveColorBoxSettingAfterProcessPackage({
        PackageDetailsList: this.tableData,
