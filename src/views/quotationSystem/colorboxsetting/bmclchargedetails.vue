<template>
  <transition name="el-zoom-in-center">
    <el-tabs type="border-card" class="w-100 h-100">
      <el-tab-pane label="后工表面处理参数设置" class="w-100 h-100">
          ...
          <div class="w-100 pd-0">
            ...
            >
              ...
              <el-table-column align="center" prop="sName" label="名称">
                ...
                </template>c:\Users\周涛\AppData\Local\Temp\WeChat Files\1ced7a047d218db601725bc7761cf7e.jpg
              </el-table-column>
              <el-table-column>
                <template slot="header">
                  <div class="text-center">单裱收费</div>
                </template>
              ...
              <el-table-column align="center" label="操作" width="80" fixed="right">
                <template slot-scope="scope">
                  ...
                  <el-button size="mini" type="text" class="YZ-table-delBtn" @click="remove(scope.row, scope.$index, 'Ele_ColorBoxSetting_AfterProcess_Surface')">删除</el-button>
                </template>
              </el-table-column>
            </el-table>
          </div>
...
export default {
  ...
  methods: {
    getList() {
      this.tableData = []
      this.loading = true
      Api.GetColorBoxSettingAfterProcessSurfaceListData(this.uGuid1)
        .then(res => {
