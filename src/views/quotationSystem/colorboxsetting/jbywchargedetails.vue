<template>
  <transition name="el-zoom-in-center">
    <el-tabs type="border-card" class="w-100 h-100">
      <el-tab-pane label="后工局部压纹参数设置" class="w-100 h-100">
            ...
            >
              ...
              <el-table-column align="center" label="操作" width="80" fixed="right">
                <template slot-scope="scope">
                  ...
                  <el-button size="mini" type="text" class="YZ-table-delBtn" @click="remove(scope.row, scope.$index, 'Ele_ColorBoxSetting_AfterProcess_LocalEmbossing')">
                    删除
                  </el-button>
                </template>
              </el-table-column>
...
export default {
  ...
  methods: {
    ...
    sumbit() {
      ...
      Api.SaveColorBoxSettingAfterProcessLocalEmbossing({
        localEmbossingDetailsList: this.tableData,
